...
@section('page_title', 'NON-LANDED RESIDENTIAL')
...
@section('contents')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                    <h2 class="title">NON-LANDED RESIDENTIAL</h2>
                </div>
                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
    ...
    <div class="content">
        <div class="container">
            <div class="row">
                <h4 class="text-center">ENTER PROJECT NAME OR STREET NAME (NON-LANDED RESIDENTIAL)</h4>
                        ...
                        <div class="post-content">
                            ...
                            <div class="row search_result_item p-40">
                                ...
                                @foreach($projects['projects_25_28'] as $item)
                                    <div class="col-md-3">
                                        <p><a href="{{ asset('/trends-and-analysis/residential/report?p=' . $item['Project Name'] ) }}">{{ $item['Project Name'] }}</a></p>
                                    </div>
                                @endforeach
                            </div>
    ...
    <script>
        ...
        $('#search_project').select2({
            ajax: {
                ...
                // ajax search url
                url: "{{ url('trends-and-analysis/residential/searchData') }}",
                dataType: 'json',
                type:"post",
        ...
        $('#bindSearch').on('click', function () {
            if($('#search_project').select2('data').length) {
                ...
                window.location.href = "{{ url('/trends-and-analysis/residential/report?p=') }}" + project_name;
            }
        })
    </script>
@endsection
